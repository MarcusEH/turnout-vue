<template>
  <div id="app">
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="#">Turnout</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="/#/users/show">Profile</a>
          </li>
                ...
                <ul id="topMain" class="nav nav-pills nav-main">
                  <li class="dropdown"><!-- HOME -->
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="divider"></li>
                      <li><a href="start-revslider.html" data-toggle="tooltip" data-placement="top" title="57 More Revolution Slider V5"><span class="badge badge-danger float-right">new</span> 57 MORE LAYOUTS</a></li>
                      <li class="divider"></li>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li class="active"><a href="feature-content-bg-ggreen.html">CONTENT - GRAIN GREEN</a></li>
